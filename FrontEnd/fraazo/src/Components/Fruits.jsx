   ...
   useEffect(()=>{
    ...
    return (
        <div className="containerdv">
            ...
            <button value="apple" onClick={(e)=>{handelFruiits(e)}}>APPLE</button>
            <hr></hr>
           <button value="Banana" onClick={(e)=>{handelFruiits(e)}}>Banana</button>
           <hr></hr>
           <button value="pomegrante" onClick={(e)=>{handelFruiits(e)}}>Pomegrante</button>
